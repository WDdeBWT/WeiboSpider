...
## ms.ExecNonQuery("insert into WeiBoUser values('2','3')")
    ...
    ms = MSSQL(host='119.23.239.27', user='WeiboSpiderUser', pwd='weibospideruser', db='GuestBook')
    resList = ms.ExecQuery("SELECT * FROM tbGuestBook")
    for weibocontent in resList:
